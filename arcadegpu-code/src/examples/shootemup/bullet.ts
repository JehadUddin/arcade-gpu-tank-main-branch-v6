  ...
  constructor(type: number) {
    ...
    switch (this.type) {
      case BulletType.Circle:
        ...
        this.jss.setTexture(gfx2TextureManager.getTexture('./examples/shootemup/circle-bullet.png'));
        break;
      case BulletType.Orbit:
          this.maxLifetime = 2000;
          this.jss.setTexture(gfx2TextureManager.getTexture('./examples/shootemup/orbit-bullet.png'));
          break;
      case BulletType.EnemyNormal:
          this.maxLifetime = 99999;
          this.jss.setTexture(gfx2TextureManager.getTexture('./examples/shootemup/enemy-circle-bullet.png'));
          break;
        case BulletType.EnemyLaser:
          this.maxLifetime = 99999;
          this.jss.setTexture(gfx2TextureManager.getTexture('./examples/shootemup/enemy-bullet.png'));
          break;
      ...
      default:
        this.maxLifetime = 99999;
        this.jss.setTexture(gfx2TextureManager.getTexture('./examples/shootemup/bullet.png'));
        break;
    }
  }
}
