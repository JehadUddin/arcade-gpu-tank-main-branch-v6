...
class GameOverScreen extends Screen {
  ...
  async onEnter(data: { score: number }) {
    await soundManager.loadSound('./examples/shootemup/game-over.wav');
    soundManager.playSound('./examples/shootemup/game-over.wav', false);
  ...
  onExit() {
    soundManager.deleteSound('./examples/shootemup/game-over.wav');
