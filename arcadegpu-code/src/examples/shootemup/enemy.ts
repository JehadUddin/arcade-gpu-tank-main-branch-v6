...
export class EnemyComponent extends DNAComponent {
  ...
  constructor(x: number, y: number, type: number,level: number) {
    ...
    case 2:
      ...
      this.jss.setTexture(gfx2TextureManager.getTexture('./examples/shootemup/enemy2.png'));
      break;
    case 3:
      this.raidDuration = 2000;
      this.jss.setTexture(gfx2TextureManager.getTexture('./examples/shootemup/enemy3.png'));
      break;
    default:
      this.raidDuration = 0;
      this.jss.setTexture(gfx2TextureManager.getTexture('./examples/shootemup/enemy1.png'));
    }
    // this.explosion = new Gfx2SpriteJAS();
    // this.explosion.setPosition(x, y);
    // this.explosion.setTexture(gfx2TextureManager.getTexture('./examples/shootemup/explosion.png'));
  }
}
