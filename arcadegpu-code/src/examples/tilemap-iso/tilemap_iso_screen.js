...
class TilemapIsoScreen extends Screen {
  constructor() {
    ...
    this.collisionLayer = new Gfx2TileIsoMapLayer();
    this.occludersLayer = new Gfx2TileIsoMapLayer();
    this.wallsLayer = new Gfx2TileIsoMapLayer();
    this.floorLayer = new Gfx2TileIsoMapLayer();
    this.collisionTileLayer = new Gfx2TileLayer();
    this.controller = new Controller();
  }

  async onEnter() {
    await this.tilemap.loadFromFile('./examples/tilemap-iso/tilemap.json');
