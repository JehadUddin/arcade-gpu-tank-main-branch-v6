...
class MenuRingScreen extends Screen {
  ...
  async onEnter() {
    ...
    canvas.style.backgroundImage = 'url(./examples/menu-ring/bg.png)';

    this.models.push(await LOAD_MODEL('./examples/menu-ring/scar.bsm', './examples/menu-ring/scar.jpeg'));
    this.models.push(await LOAD_MODEL('./examples/menu-ring/shotgun.bsm', './examples/menu-ring/shotgun.jpeg'));
    this.models.push(await LOAD_MODEL('./examples/menu-ring/usp.bsm', './examples/menu-ring/usp.jpeg'));
    this.models.push(await LOAD_MODEL('./examples/menu-ring/m4.bsm', './examples/menu-ring/m4.jpeg'));
