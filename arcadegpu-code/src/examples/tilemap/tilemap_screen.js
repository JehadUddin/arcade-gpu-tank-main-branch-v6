...
class TilemapScreen extends Screen {
  ...
  async onEnter() {
    await this.tileMap.loadFromFile('./examples/tilemap/map.jtm');
    ...
    await this.collisionMap.loadFromFile('./examples/tilemap/collision.jtm');
    this.collisionTileLayer = this.collisionMap.getTileLayer(0);

    await this.controller.loadFromFile('./examples/tilemap/bernard.json');
