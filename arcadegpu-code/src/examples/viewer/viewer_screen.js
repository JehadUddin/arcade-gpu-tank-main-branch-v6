...
async function CREATE_SKYBOX() {
  ...
  skybox.setCubemap(await gfx3TextureManager.loadCubemapTexture('./examples/viewer/skybox/sky_', 'png'));
  return skybox;
}
...
async function CREATE_CUBE_BRICK() {
  ...
  mesh.mat.setArcadeEnabled(true);
  mesh.mat.setArcadeStartColor(0.5, 0.5, 0.1);
  mesh.mat.setArcadeEndColor(0.5, 0.5, 0.1);
  mesh.mat.setArcadeSharpColor(1.0, 1.0, 1.0);
  return mesh;
}
