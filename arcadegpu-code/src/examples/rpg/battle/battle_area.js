...
class BattleArea {
  ...
  async loadFromBattle(battle) {
    ...
    this.focusIcon = new Gfx3MeshJSM();
    this.focusIcon.mat.setTexture(await gfx3TextureManager.loadTexture('examples/rpg/jsms/focus.png'));
    await this.focusIcon.loadFromFile('examples/rpg/jsms/focus.jsm');
