...
export async function spawnPlayer(jnm: Gfx3PhysicsJNM): Promise<number> {
  ...
  await graphics.jam.loadFromFile('./examples/third-person/barret.jam');
  graphics.jam.play('IDLE', true);
  graphics.jam.mat.setTexture(await gfx3TextureManager.loadTexture('./examples/third-person/barret.png'));
