...
const ComboFactory = {
  ...
  SPECIAL: async (charName) => {
    ...
    bgJSS.setTexture(await gfx2TextureManager.loadTexture('examples/fight/chars/' + charName + '/bg-special-attack.png'));
  
    const avatarJSS = new Gfx2SpriteJSS();
    avatarJSS.setTexture(await gfx2TextureManager.loadTexture('examples/fight/chars/' + charName + '/avatar-special-attack.png'));
