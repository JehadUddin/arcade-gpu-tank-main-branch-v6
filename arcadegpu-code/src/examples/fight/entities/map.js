...
export async function spawnMap(map) {
  ...
  backgroundJSS.setTexture(await gfx2TextureManager.loadTexture('examples/fight/backgrounds/' + map + '/layer.png'));
  ...
  await jas.loadFromFile('examples/fight/backgrounds/' + map + '/floating-rock.jas');
  jas.setTexture(await gfx2TextureManager.loadTexture('examples/fight/backgrounds/' + map + '/floating-rock.png'));
  jas.setOffset(+52, +18);
